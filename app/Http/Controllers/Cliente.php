...
class Cliente extends Controller
{
        ...
        if (is_array($params)) {
            ...
            foreach (get_object_vars($this) as $key => $attribute) {
                ...
                switch ($key) {
                    ...
                    case 'documentType':
                        if (isset($this->documentType) and $this->documentType != null) {
                    ...
                    case 'emailAddress':
                        if (isset($this->emailAddress) and $this->emailAddress != null) {
    ...
    {
        if (isset($string) and $string != null and $string != '') {
            if (is_string($string)) {
