        ...
        <div class="col-xs-12 col-md-10 col-centered box-content">
            ...
            <div class="row">
                ...
                <div class="form-group col-xs-12 col-sm-6">
                    <label>
                        Dirección</label>
                    <input type="text" class="form-control" id="txtDireccion" name="txtDireccion" placeholder="Dirección de residencia o trabajo" maxlength="64" data-toggle="tooltip" data-placement="top" data-fv-notempty="true" data-fv-notempty-message="El campo dirección es requerido" data-fv-stringlength-min="1" data-fv-stringlength-max="64" data-fv-stringlength-message="El campo dirección debe tener hasta 64 caracteres" data-fv-field="txtDireccion" title="" data-original-title="Ingresa tu dirección" style="display: none;">
                ...
                <small class="help-block" data-fv-validator="notEmpty" data-fv-for="txtDireccion" data-fv-result="NOT_VALIDATED" style="display: none;">El campo dirección es requerido</small><small class="help-block" data-fv-validator="stringLength" data-fv-for="txtDireccion" data-fv-result="NOT_VALIDATED" style="display: none;">El campo dirección debe tener hasta 64 caracteres</small><small class="help-block" data-fv-validator="notEmpty" data-fv-for="txtDireccionPJ" data-fv-result="NOT_VALIDATED" style="display: none;">El campo dirección es requerido</small><small class="help-block" data-fv-validator="stringLength" data-fv-for="txtDireccionPJ" data-fv-result="NOT_VALIDATED" style="display: none;">El campo dirección debe tener hasta 64 caracteres</small></div>
            </div>
            <hr>
            <div class="row">
                <div class="form-group col-xs-12 col-sm-6">
                    <label>
                        E-mail</label>
                    <input type="email" class="form-control" id="email" name="email" placeholder="E-mail" maxlength="120" data-toggle="tooltip" title="" data-placement="top" data-fv-notempty="true" data-fv-notempty-message="El campo e-mail es requerido" data-fv-emailaddress-message="El campo e-mail es inválido" data-fv-stringlength-max="120" data-fv-stringlength-message="El campo e-mail debe tener hasta 120 caracteres" data-fv-field="email" data-original-title="Relaciona tu correo electrónico.">
                <small class="help-block" data-fv-validator="emailAddress" data-fv-for="email" data-fv-result="NOT_VALIDATED" style="display: none;">El campo e-mail es inválido</small><small class="help-block" data-fv-validator="notEmpty" data-fv-for="email" data-fv-result="NOT_VALIDATED" style="display: none;">El campo e-mail es requerido</small><small class="help-block" data-fv-validator="stringLength" data-fv-for="email" data-fv-result="NOT_VALIDATED" style="display: none;">El campo e-mail debe tener hasta 120 caracteres</small></div>
                <div class="form-group col-xs-12 col-sm-6">
                    <label>
                        Confirmar e-mail</label>
                    <input type="email" class="form-control" id="emailConfirmacion" name="emailConfirmation" placeholder="Confirmar e-mail" maxlength="120" data-toggle="tooltip" data-placement="top" data-fv-notempty="true" data-fv-notempty-message="El campo confirmación de e-mail es requerido" data-fv-emailaddress-message="El campo confirmación de e-mail es inválido" data-fv-stringlength-max="120" data-fv-stringlength-message="El campo confirmación de e-mail debe tener hasta 120 caracteres" data-fv-identical="true" data-fv-identical-field="email" data-fv-identical-message="El campo confirmación e-mail no coincide con el campo e-mail" data-fv-field="emailConfirmation" title="" data-original-title="Confirma tu correo electrónico">
                <small class="help-block" data-fv-validator="emailAddress" data-fv-for="emailConfirmation" data-fv-result="NOT_VALIDATED" style="display: none;">El campo confirmación de e-mail es inválido</small><small class="help-block" data-fv-validator="identical" data-fv-for="emailConfirmation" data-fv-result="NOT_VALIDATED" style="display: none;">El campo confirmación e-mail no coincide con el campo e-mail</small><small class="help-block" data-fv-validator="notEmpty" data-fv-for="emailConfirmation" data-fv-result="NOT_VALIDATED" style="display: none;">El campo confirmación de e-mail es requerido</small><small class="help-block" data-fv-validator="stringLength" data-fv-for="emailConfirmation" data-fv-result="NOT_VALIDATED" style="display: none;">El campo confirmación de e-mail debe tener hasta 120 caracteres</small></div>
            </div>
            <hr>
            <div class="row">
                <div class="form-group col-xs-12">
